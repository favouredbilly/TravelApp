      ...
      {destination === "Tikkurila" && (
        <div className="destination-content">
          ...
          <div className="destination-content1">
            <ol>
              <li>
                Take Bus 570 from Tikkurila. Buses arrive approximately every 10
                minutes.
              </li>
              <li>Get off at Silvastintie Bus stop.</li>
              <li>
                Follow the directions provided in the video below to reach
                Skyline Airport Hotel:
              </li>
            </ol>
            <div className="video-container">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/NTLk_us1wUE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
          </div>
        </div>
      )}
